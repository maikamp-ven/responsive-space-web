...
const blurHeader = () => {
  ...
  //Add a class if the bottom offset if greater than 50 50 of the viewport
...
sr.reveal(`.footer_planet-1`, {origin: 'bottom', delay: 600})
sr.reveal(`.footer_planet-2`, { delay: 800})